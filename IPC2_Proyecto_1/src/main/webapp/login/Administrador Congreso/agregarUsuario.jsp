    ...
    <body class="bg-dark text-light">
        <div class="centered-form">
            <div class="register-card">
                ...
                <form method="post" action="${pageContext.servletContext.contextPath}/controllerUsuarioAC" enctype="multipart/form-data">
                ...
                <div class="text-center mt-3 small">
                    <a href="${pageContext.request.contextPath}/controllerUsuarioAC" class="text-info text-decoration-none">Regresar</a>
                </div>
            </div>
        </div>
    </body>
