    ...
    <body class="bg-dark text-light">
        <div class="centered-form">
            <div class="register-card">
                ...
                <form method="post" action="${pageContext.servletContext.contextPath}/controllerUsuarioActualizarAC" enctype="multipart/form-data">
                    ...
                    <div class="select-row mb-3">
                        ...
                        <div>
                            ...
                            <select id="rol" name="rol" class="form-control">
                                <option value="Administrador Congreso" ${usuario.rol eq 'Administrador Sistema' ? "selected" : ""}>Administrador Congreso</option>
                                <option value="Comité Científico" ${usuario.rol eq 'Administrador Congreso' ? "selected" : ""}>Comité Científico</option>
                ...
                <div class="text-center mt-3 small">
                    <a href="${pageContext.request.contextPath}/controllerUsuarioAC" class="text-info text-decoration-none">
