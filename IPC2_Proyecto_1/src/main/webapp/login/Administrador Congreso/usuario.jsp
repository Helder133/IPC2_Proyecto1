    ...
    <body class="bg-dark text-light">
        ...
        <div class="container py-4">
            <div class="d-flex justify-content-center mb-4">
                <a href="${pageContext.servletContext.contextPath}/login/Administrador Congreso/agregarUsuario.jsp" 
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-lg-10">
                    <form method="get" action="${pageContext.servletContext.contextPath}/controllerUsuarioAC" class="row g-2">
                    ...
                    <div class="col">
                        <div class="card h-100 bg-secondary text-light border-light user-card">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <a href="${pageContext.servletContext.contextPath}/controllerUsuarioActualizarAC?id=${usuario.DPI_o_Pasaporte}" 
