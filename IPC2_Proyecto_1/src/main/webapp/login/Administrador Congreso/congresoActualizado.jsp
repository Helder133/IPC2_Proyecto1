<%-- 
    Document   : congresoActualizado
    Created on : 23/09/2025, 10:50:02
    Author     : helder
--%>
...
<html>
    <head>
        ...
        <title>Actualizar Congreso</title>
    </head>
                        ...
                        <c:if test="${congreso != null}">
                            <div class="card shadow-lg border-0 success-card text-light">
                                <div class="card-header text-center fw-bold bg-dark text-warning py-3">
                                    <i class="bi bi-check-circle-fill me-2"></i>Congreso actualizado.
                                </div>
                                <div class="card-body text-center p-4">
                                    <h5 class="card-title mb-3">Actualizacion exitoso</h5>
                        ...
                        <c:if test="${congreso == null}">
                            <div class="alert error-alert text-light p-4" role="alert">
                                ...
                                <div class="text-center mt-3">
                                    <a href="${pageContext.request.contextPath}/ControllerCongreso"
