<%-- 
    ...
    Created on : 22/09/2025, 12:30:00
    Author     : helder
--%>
                        ...
                        <c:if test="${usuario != null}">
                            <div class="card shadow-lg border-0 success-card text-light">
                                <div class="card-header text-center fw-bold bg-dark text-warning py-3">
                                    <i class="bi bi-check-circle-fill me-2"></i>Perfil actualizado ${usuario.DPI_o_Pasaporte}
                                </div>
                                <div class="card-body text-center p-4">
                                    ...
                                    <a href="${pageContext.request.contextPath}/controllerPerfil" class="btn btn-warning w-100 py-2">
                        ...
                        <c:if test="${usuario == null}">
                            <div class="alert error-alert text-light p-4" role="alert">
                                ...
                                <div class="text-center mt-3">
                                    <a href="${pageContext.request.contextPath}/controllerPerfil"
