 ...
 */
@MultipartConfig
@WebServlet(name = "controllerUsuarioActualizarAC", urlPatterns = {"/controllerUsuarioActualizarAC"})
public class controllerUsuarioActualizarAC extends HttpServlet {
   ...
   @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher dispatcher = getServletContext()
                    .getRequestDispatcher("/login/Administrador Congreso/actualizarUsuario.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = getServletContext()
                    .getRequestDispatcher("/login/Administrador Congreso/usuarioActualizado.jsp");
            dispatcher.forward(request, response);
    }
