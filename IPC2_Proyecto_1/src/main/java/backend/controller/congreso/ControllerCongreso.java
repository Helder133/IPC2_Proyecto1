...
public class ControllerCongreso extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (obtenerTodos(request)) {
                ...
                List<Congreso> congresos = congresoDAO.seleccionarPorParametroDpOE(request.getParameter("nombre"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Congreso congreso = extraccion.extraerUsuarioFormulario(request, idUsuario, organizacion);
            CongresoDAO congresoDAO = new CongresoDAO();
